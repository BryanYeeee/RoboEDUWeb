...
class Navbar extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      className: "fixed top-0 left-0 w-full lg:flex justify-between xl:px-24 px-10 py-2 bg-slate-700 duration-700"
      ...
      className: "w-7/12 p-1 mr-1 rounded border-2 border-blue-600"
      ...
      className: "lg:flex justify-around mt-5 items-center lg:mt-0 lg:w-2/3 text-slate-100 duration-500"
